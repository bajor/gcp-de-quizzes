...
The project is governed by the [product constitution](/constitution.md).

## Index

- [Architecture](/architecture.md) - Implemented module ownership, authoring flow, attempt data flow, quality gates, and deployment.
- [Context](/context/index.md) - Application, section-authoring, question-lifecycle, and exam vocabulary.
...
- [Issues](/issues/index.md) - Execution records linked to current requirements and superseding decisions.
